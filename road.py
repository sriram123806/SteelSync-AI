...
async def main():
    ...
    agent_id, api_key = load_agent_config("road")

    print("Road Agent ID loaded successfully")
...
"""
    ...
    print("====================================")
    print("SteelSync Road Agent is ONLINE")
